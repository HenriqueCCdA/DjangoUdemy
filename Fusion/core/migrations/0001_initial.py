# Generated by Django 4.0.1 on 2022-01-20 18:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-rocket', 'Foguete'), ('lni-cog', 'Engenagem'), ('lni-mobile', 'Mobile'), ('lni-stats-up', 'Gráfico'), ('lni-layers', 'Design'), ('lni-users', 'Usuário')], max_length=12, verbose_name='Icone')),
            ],
            options={
